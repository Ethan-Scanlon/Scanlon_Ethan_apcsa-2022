...
public class OddToEvenRunner
{
	public static void main( String args[] )
	{
		...
		ray2 = new ArrayList<Integer>(Arrays.asList(11,9,8,7,6,5,4,3,2,1,-99,7));
		System.out.println(ListOddToEven.go(ray2));
		
		ArrayList<Integer> ray3;
		ray3 = new ArrayList<Integer>(Arrays.asList(10,20,30,40,5,41,31,20,11,7));
		System.out.println(ListOddToEven.go(ray3));
		
		ArrayList<Integer> ray4;
		ray4 = new ArrayList<Integer>(Arrays.asList(32767,70,4,5,6,7));
