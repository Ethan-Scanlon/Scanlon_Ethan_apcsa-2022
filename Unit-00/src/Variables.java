...
public class Variables
{
	public static void main ( String[] args )
	{
		...
		//integer variables
		byte byteOne = 127;
		short shortOne = -32323;
		int intOne = 4342;
		long longOne = 23111155;


		//decimal variables

		float floatOne = (float)22.4545;
		double doubleOne = 256456.343;
		...
		System.out.println("*                               *");
		System.out.println("*16 bit - charOne = A "+charOne+"\t\t*");
		System.out.println("*                               *");
